...
//	{
//    double majorStep = 2.0f*_PI / numMajor;
//    double minorStep = 2.0f*_PI / numMinor;
//    int i, j;
//	
...
//
//		EGE::m3d::Vector3f vVertex[4];
//		EGE::m3d::Vector3f vNormal[4];
//		EGE::m3d::Vector2f vTexture[4];
//		
...
//			EGE::m3d::NormalizeVector3(vNormal[0]);
//			vVertex[0][0] = x0 * r;
//			vVertex[0][1] = y0 * r;
//			vVertex[0][2] = z;
//			
...
//			EGE::m3d::NormalizeVector3(vNormal[1]);
//			vVertex[1][0] = x1*r;
//			vVertex[1][1] = y1*r;
//			vVertex[1][2] = z;
//
...
//			EGE::m3d::NormalizeVector3(vNormal[2]);
//			vVertex[2][0] = x0 * r;
//			vVertex[2][1] = y0 * r;
//			vVertex[2][2] = z;
//			
...
//			EGE::m3d::NormalizeVector3(vNormal[3]);
//			vVertex[3][0] = x1*r;
//			vVertex[3][1] = y1*r;
//			vVertex[3][2] = z;
//
...
//			memcpy(vVertex[0], vVertex[1], sizeof(EGE::m3d::Vector3f));
//			memcpy(vNormal[0], vNormal[1], sizeof(EGE::m3d::Vector3f));
//			memcpy(vTexture[0], vTexture[1], sizeof(EGE::m3d::Vector2f));
//			
//			memcpy(vVertex[1], vVertex[3], sizeof(EGE::m3d::Vector3f));
//			memcpy(vNormal[1], vNormal[3], sizeof(EGE::m3d::Vector3f));
//			memcpy(vTexture[1], vTexture[3], sizeof(EGE::m3d::Vector2f));
//					
//			torusBatch.AddTriangle(vVertex, vNormal, vTexture);			
//			}
//		}
...
//		
//		float zNormal = 0.0f;
//		if(!EGE::m3d::CloseEnough(baseRadius - topRadius, 0.0f, 0.00001f))
//			{
//			// Rise over run...
...
//			
//			if(!EGE::m3d::CloseEnough(fNextRadius, 0.0f, 0.00001f)) {
...
//				}
//			else
//				memcpy(vNormal[2], vNormal[3], sizeof(EGE::m3d::Vector3f));
//				
//
